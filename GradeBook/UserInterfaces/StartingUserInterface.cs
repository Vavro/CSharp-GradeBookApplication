...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            switch(type)
            {
                case "standard": gradeBook = new StandardGradeBook(name, isWeighted);
                    break;
                case "ranked": gradeBook = new RankedGradeBook(name, isWeighted);
                    break;
                default: Console.WriteLine("{0} is not a supported type of gradebook, please try again", type);
                    return;
            }
